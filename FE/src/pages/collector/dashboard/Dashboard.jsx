...
const Toggle = ({ checked, onChange }) => {
  return (
    <button
      type="button"
      onClick={onChange}
      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 ${checked ? "bg-green-500" : "bg-gray-200"
        }`}
    >
      <span
        aria-hidden="true"
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4 lg:gap-6">
            ...
            <div className="bg-white rounded-xl p-4 lg:p-6 flex items-center gap-3 lg:gap-4 shadow-sm border border-gray-100 transition-all hover:shadow-md">
              <div className="w-11 h-11 lg:w-14 lg:h-14 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 24 24" className="w-6 h-6 lg:w-7 lg:h-7 text-green-600" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex-1">
                <p className="font-semibold text-gray-800 text-sm lg:text-base">Sẵn sàng làm việc</p>
          ...
          <div className="lg:col-span-8 flex flex-col gap-4 lg:gap-6 mt-2 lg:mt-0">
            <h3 className="font-bold text-gray-900 text-lg lg:text-2xl px-1">Tổng quan nhiệm vụ</h3>
              ...
              <div className="md:col-span-2 grid grid-cols-2 gap-4 lg:gap-6">
                ...
                <div className="bg-white rounded-2xl p-4 lg:p-6 shadow-sm border border-gray-100 flex flex-col justify-between transition-all hover:shadow-md hover:border-green-100">
                  <div className="flex items-center justify-between mb-4 lg:mb-6">
                    <span className="text-gray-500 text-xs lg:text-sm font-medium">Đang chờ</span>
                  ...
                  <div>
                    <div className="flex items-end gap-2">
                      <span className="text-4xl lg:text-5xl font-bold text-gray-900">12</span>
                    </div>
                    <p className="text-green-600 text-xs lg:text-sm font-medium mt-2">+2 nhiệm vụ mới</p>
                  </div>
                </div>
                ...
                <div className="bg-red-50 rounded-2xl p-4 lg:p-6 shadow-sm border border-red-100 flex flex-col justify-between transition-all hover:shadow-md">
                  <div className="flex items-center justify-between mb-4 lg:mb-6">
                    <span className="text-red-600 text-xs lg:text-sm font-medium">Sắp quá hạn</span>
                    <AlertTriangle className="w-5 h-5 lg:w-6 lg:h-6 text-red-500" />
                  </div>
                  <div>
                    <div className="flex items-end gap-2">
                      <span className="text-4xl lg:text-5xl font-bold text-red-600">3</span>
                    </div>
              ...
              <div className="flex items-center justify-between px-4 lg:px-6 py-3 lg:py-4 border-b border-gray-50">
                <div className="flex items-center gap-2 lg:gap-3">
                  <div className="w-6 h-6 lg:w-8 lg:h-8 rounded bg-green-100 flex items-center justify-center">
                    <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 lg:w-4 lg:h-4 text-green-600" fill="currentColor">
                      <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
                    </svg>
                  </div>
                  <span className="font-semibold text-gray-800 text-sm lg:text-base">Khu vực làm việc</span>
                </div>
